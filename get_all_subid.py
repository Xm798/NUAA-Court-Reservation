...
for i in [13, 14, 15, 16, 17, 19, 20]:
    ...
    headers = {
        ...
        'Cookie': 'vjuid=162966; vjvd=32f83e1ac9b6de2c9e091258a4eb7182; vt=163709651; PHPSESSID=4kmj5ojvlkt8rd9a9tkua4icv3; PHPSESSID=b8ocmemufmpn0qv38d9lj3dkg1; vjuid=162966; vjvd=32f83e1ac9b6de2c9e091258a4eb7182; vt=163742230',
...
def request(*args, **kwargs):
    ...
    while is_retry and count <= max_retries:
        try:
            ...
            count += 1
            print(f'Trying to reconnect in {sleep_seconds} seconds ({count}/{max_retries})...')
